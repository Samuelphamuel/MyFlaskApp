...
app = Flask(__name__)
# database user:password@localhost/database credentials
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:pa$$w0rd@localhost/storedata'
...
def create_sale():
    if request.method == 'POST':
        ...
        transaction_date = datetime.fromisoformat(request.form['transaction_date'])
...
def update_sale(id):
    ...
    if request.method == 'POST':
        ...
        sale.transaction_date = datetime.fromisoformat(request.form['transaction_date'])
